...
const TimelineElement = ({title, isLast}: TimelineElementProps) => {
    return (
        <div>
            <div className={`after:absolute after:h-5 after:w-5 after:bg-unfocused after:rounded-full after:translate-x-1/2 before:w-1 before:h-1/3 before:bg-unfocused before:absolute before:left-21 before:-translate-x-1/2 before:translate-y-2 ${isLast && "before:hidden"}`}/>
